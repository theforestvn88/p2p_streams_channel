...
export default class extends P2pController {
    ...
    //
    p2pNegotiating() {
        // your peer is negotiating with the host through ActionCable
    }
    ...
    p2pConnected() {
        // your peer's connected to the host peer and disconnect from the server
        // only the host peer still keep connection to the server
